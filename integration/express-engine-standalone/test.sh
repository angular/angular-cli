...
mkdir -p "$tmpdir/integration/express-engine-standalone"
rsync -a -L integration/express-engine-standalone/ "$tmpdir/integration/express-engine-standalone" --exclude node_modules
...
cd "$tmpdir/integration/express-engine-standalone"
