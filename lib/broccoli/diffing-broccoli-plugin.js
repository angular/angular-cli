...
var DiffingPluginWrapper = (function () {
    ...
    DiffingPluginWrapper.prototype.init = function () {
        if (!this.initialized) {
            ...
            if (this.inputPaths) {
                this.treeDiffers =
                    this.inputPaths.map(function (inputPath) { return new tree_differ_1.TreeDiffer(description, inputPath, includeExtensions, excludeExtensions); });
            }
            else if (this.inputPath) {
                this.treeDiffer =
                    new tree_differ_1.TreeDiffer(description, this.inputPath, includeExtensions, excludeExtensions);
            }
