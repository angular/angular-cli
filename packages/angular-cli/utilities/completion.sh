...
init_opts='--dry-run --inline-style --inline-template --link-cli --mobile --name --prefix --routing --skip-commit --skip-git --skip-npm --source-dir --style --verbose -d -is -it -lc -n -p -sb -sc -sd -sg -sn -v'
new_opts='--directory --dry-run --inline-style --inline-template --link-cli --mobile --prefix --routing --skip-comit --skip-git --skip-npm --source-dir --style --verbose -d -dir -is -it -lc -p -sb -sc -sd -sg -sn -v'
