...
type AddCommandOptions = Options<AddCommandArgs>;
...
export class AddCommandModule extends SchematicCommand<AddCommandOptions> {
  override readonly allowPrivateSchematics = true;

  // eslint-disable-next-line max-lines-per-function
  async run(options: AddCommandOptions) {
