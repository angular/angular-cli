...
export class UpdateCommand extends Command<UpdateCommandOptions> {
  ...
  override async initialize(options: UpdateCommandOptions) {
  ...
  async run(options: UpdateCommandOptions) {
