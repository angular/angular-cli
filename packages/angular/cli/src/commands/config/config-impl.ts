...
type ConfigCommandOptions = Options<ConfigCommandArgs>;
...
export class ConfigCommand extends Command<ConfigCommandOptions> {
  public async run(options: ConfigCommandOptions) {
