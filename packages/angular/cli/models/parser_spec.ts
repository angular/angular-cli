...
describe('parseArguments', () => {
  describe('given options are provided', () => {
    const options: Option[] = [
      ...
      { name: 'bool2', aliases: ['B'], type: OptionType.Boolean, description: '' },
      ...
      { name: 'e1', aliases: [], type: OptionType.String, enums: ['hello', 'world'], description: '' },
      { name: 'e2', aliases: [], type: OptionType.String, enums: ['hello', ''], description: '' },
      {
        name: 'e3', aliases: [], type: OptionType.Boolean,
        types: [OptionType.Boolean, OptionType.String], enums: ['json', true, false],
        description: '',
      },
    ];

    const tests: Record<string, Partial<Arguments> | ['!!!', Partial<Arguments>, string[]]> = {
      '-S=b': { strUpper: 'b' },
      '--bool': { bool: true },
      '-bB': { bool: true, bool2: true },
      // '--bool=1': ['!!!', {}, ['bool']],
      '--bool val1': { bool: true, p1: 'val1' },
      '-- --bool=1': { '--': ['--bool=1'] },
      // '--bool=yellow': ['!!!', {}, ['bool']],
      '--bool=true': { bool: true },
      ...
      '--str=false --num': { str: 'false', num: 0 },
      '--str=false --numx': { str: 'false', '--': ['--numx'] },
      '--str=false val1 --numx': { str: 'false', p1: 'val1', '--': ['--numx'] },
      '--str=false val1 val2': { str: 'false', p1: 'val1', p2: 'val2' },
      '--str=false val1 val2 --numx': { str: 'false', p1: 'val1', p2: 'val2', '--': ['--numx'] },
      '--str=false val1 --numx val2': { str: 'false', p1: 'val1', '--': ['--numx', 'val2'] },
  ...
  describe('given options are not provided', () => {
    const tests: Record<string, Partial<Arguments>> = {
      '--bool': { bool: true },
      '--bool false': { bool: false },
      '--bool true': { bool: true },
      '--no-bool': { bool: false },
      ...
      '--str val1': { str: 'val1' },
      '--num 1': { num: 1 },
      'foo --bool': { bool: true, '--': ['foo'] },
      '--arr val1 --arr val2': { arr: ['val1', 'val2'] },
      '-- --bool=1': { '--': ['--bool=1'] },
    };

    Object.entries(tests).forEach(([str, expected]) => {
      it(`works for "${str}"`, () => {
        const actual = parseArguments(str.split(' '));
