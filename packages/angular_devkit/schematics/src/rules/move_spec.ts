...
describe('move', () => {
  it('works on moving the whole structure', async () => {
    ...
    const result = await lastValueFrom(callRule(move('sub'), observableOf(tree), context));
  ...
  it('works on moving a subdirectory structure', async () => {
    ...
    const result = await lastValueFrom(callRule(move('a/b', 'sub'), observableOf(tree), context));
  ...
  it('works on moving a directory into a subdirectory of itself', async () => {
    ...
    const result = await lastValueFrom(callRule(move('a/b', 'a/b/c'), observableOf(tree), context));
  ...
  it('works on moving a directory into a parent of itself', async () => {
    ...
    const result = await lastValueFrom(callRule(move('a/b', 'a'), observableOf(tree), context));
  ...
  it('becomes a noop with identical from and to', async () => {
    ...
    const result = await lastValueFrom(callRule(move(''), observableOf(tree), context));
