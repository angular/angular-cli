...
export class AppComponent implements OnInit {
  ...
  // NOTE: Initialization for AIO removed so that it doesn't load files that aren't available.
  // If you update AIO, be sure to comment this on the new code as well.
  ngOnInit() {
