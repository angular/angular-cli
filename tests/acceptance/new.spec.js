...
describe('Acceptance: ng new', function() {
    ...
    it('ng new with blueprint uses the specified blueprint directory with a relative path', function() {
    ...
    it('ng new with blueprint uses the specified blueprint directory with an absolute path', function() {
        return tmp.setup('./tmp/my_blueprint')
            .then(function() {
                return tmp.setup('./tmp/my_blueprint/files');
            })
    ...
    // Commented out since repository app-blueprint-test not exists
    /*
