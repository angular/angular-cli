...
export default async function () {
  ...
  await replaceInFile('src/app/app.ts', 'imports: [', 'imports: [I18nLibTestComponent,');
  await prependToFile('src/app/app.ts', `import { I18nLibTestComponent } from 'i18n-lib-test';`);
