...
export default function () {
  ...
  return updateJsonFile('package.json', packageJson => {
    ...
    // .then(() => ng('e2e', 'app-e2e', '--specs', './e2e/renamed-app.e2e-spec.ts',
    ...
    .then(() => execAndWaitForOutputToMatch('ng', ['e2e', 'app-e2e', '--element-explorer'],
      /Element Explorer/))
    ...
    .then(() => ng('e2e', 'app-e2e', '--devServerTarget='))
    .then(() => killAllProcesses(), (err: any) => {
      killAllProcesses();
      throw err;
    });
