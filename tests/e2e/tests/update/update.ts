...
export default async function () {
  ...
  try {
    ...
    // CLI project version
    const cliMajorProjectVersion = 20;
  ...
  await useCIChrome('twenty-project', './');
  await useCIDefaults('twenty-project');
  ...
  await executeBrowserTest({
    ...
    expectedTitleText: 'Hello, twenty-project',
  });
  await executeBrowserTest({
  ...
  await expectFileMatchToExist('dist/twenty-project/browser', /main-[a-zA-Z0-9]{8}\.js/);
}
